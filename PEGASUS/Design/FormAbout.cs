...
namespace PEGASUS.Design
{
	public class FormAbout : Form
	{
		...
		private static readonly string name = info("ZOMKY_YL_FF");
		...
		private void FormAbout_Load(object sender, EventArgs e)
		{
			...
			username.Text = "Username: " + Darkness.user_data.username;
			expiry.Text = "Expiry: " + UnixTimeToDateTime(long.Parse(Darkness.user_data.subscriptions[0].expiry)).ToString();
			registerdate.Text = "Subscription: " + Darkness.user_data.subscriptions[0].subscription;
		}
		...
		private void InitializeComponent()
		{
			...
			guna2PictureBox2.Location = new System.Drawing.Point(462, 67);
