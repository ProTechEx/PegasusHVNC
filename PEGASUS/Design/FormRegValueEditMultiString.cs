...
namespace PEGASUS.Design
{
	public class FormRegValueEditMultiString : Form
	{
		...
		public FormRegValueEditMultiString(RegistrySeeker.RegValueData value)
		{
			...
			valueDataTxtBox.Text = string.Join("\r\n", global::PEGASUS.IcarusWings.ByteConverter.ToStringArray(value.Data));
		}

		private void okButton_Click(object sender, EventArgs e)
		{
			_value.Data = global::PEGASUS.IcarusWings.ByteConverter.GetBytes(valueDataTxtBox.Text.Split(new string[1] { "\r\n" }, StringSplitOptions.RemoveEmptyEntries));
			base.Tag = _value;
