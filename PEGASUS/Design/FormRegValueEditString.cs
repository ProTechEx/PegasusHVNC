...
namespace PEGASUS.Design
{
	public class FormRegValueEditString : Form
	{
		...
		public FormRegValueEditString(RegistrySeeker.RegValueData value)
		{
			...
			valueDataTxtBox.Text = global::PEGASUS.IcarusWings.ByteConverter.ToString(value.Data);
		}

		private void okButton_Click(object sender, EventArgs e)
		{
			_value.Data = global::PEGASUS.IcarusWings.ByteConverter.GetBytes(valueDataTxtBox.Text);
			base.Tag = _value;
