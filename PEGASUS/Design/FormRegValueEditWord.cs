	...
	public class FormRegValueEditWord : Form
	{
		...
		public FormRegValueEditWord(RegistrySeeker.RegValueData value)
		{
			...
			if (value.Kind == RegistryValueKind.DWord)
			{
				...
				valueDataTxtBox.Text = global::PEGASUS.IcarusWings.ByteConverter.ToUInt32(value.Data).ToString("x");
			}
			else
			{
				Text = "Edit QWORD (64-bit) Value";
				valueDataTxtBox.Type = WordTextBox.WordType.QWORD;
				valueDataTxtBox.Text = global::PEGASUS.IcarusWings.ByteConverter.ToUInt64(value.Data).ToString("x");
			}
		}
		...
		private void okButton_Click(object sender, EventArgs e)
		{
			if (valueDataTxtBox.IsConversionValid() || IsOverridePossible())
			{
				_value.Data = ((_value.Kind == RegistryValueKind.DWord) ? global::PEGASUS.IcarusWings.ByteConverter.GetBytes(valueDataTxtBox.UIntValue) : global::PEGASUS.IcarusWings.ByteConverter.GetBytes(valueDataTxtBox.ULongValue));
				base.Tag = _value;
		...
		private void InitializeComponent()
		{
			...
			valueDataTxtBox = new IcarusWings.WordTextBox();
			...
			valueDataTxtBox.Type = IcarusWings.WordTextBox.WordType.DWORD;
