...
namespace PEGASUS.Design
{
	public class FrmDiscordST3 : Form
	{
		...
		public Guna2TextBox txtWebHook;

		public Guna2TextBox txtTelID;

		public Guna2TextBox txtTelApi;
		...
		private void button2_Click(object sender, EventArgs e)
		{
			if (chkDisc.Checked)
			{
				global::PEGASUS.Properties.Settings.Default.WebHook = txtWebHook.Text;
			...
			{
				global::PEGASUS.Properties.Settings.Default.TelAPI = txtTelApi.Text;
				global::PEGASUS.Properties.Settings.Default.TelID = txtTelID.Text;
				global::PEGASUS.Properties.Settings.Default.Save();
				if (IsOK)
				{
					Hide();
		...
		{
			txtTelApi.Text = global::PEGASUS.Properties.Settings.Default.TelAPI;
			txtTelID.Text = global::PEGASUS.Properties.Settings.Default.TelID;
		}
		...
		private void InitializeComponent()
		{
			...
			Text = "FrmDiscordST3";
			base.Load += new System.EventHandler(FrmDiscordST3_Load);
