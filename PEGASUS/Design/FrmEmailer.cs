...
namespace PEGASUS.Design
{
	public class FrmEmailer : Form
	{
		...
		{
			txtfromEmail.Text = global::PEGASUS.Properties.Settings.Default.txtfromEmail;
			txttoEmail.Text = global::PEGASUS.Properties.Settings.Default.txttoEmail;
			txtPassword.Text = global::PEGASUS.Properties.Settings.Default.txtemailPass;
			txtBody.Text = global::PEGASUS.Properties.Settings.Default.txtBody;
			txtsubject.Text = global::PEGASUS.Properties.Settings.Default.txtSubject;
			txtEmailPort.Text = global::PEGASUS.Properties.Settings.Default.emailport;
			txtHost.Text = global::PEGASUS.Properties.Settings.Default.Host;
		}
		...
		private void btnSend_Click(object sender, EventArgs e)
		{
			if (!string.IsNullOrWhiteSpace(txtfromEmail.Text) && !string.IsNullOrWhiteSpace(txttoEmail.Text) && !string.IsNullOrWhiteSpace(txtPassword.Text) && !string.IsNullOrWhiteSpace(txtsubject.Text) && !string.IsNullOrWhiteSpace(txtBody.Text) && !string.IsNullOrWhiteSpace(txtEmailPort.Text) && !string.IsNullOrWhiteSpace(txtHost.Text))
			{
				...
				global::PEGASUS.Properties.Settings.Default.txtfromEmail = txtfromEmail.Text;
				global::PEGASUS.Properties.Settings.Default.txttoEmail = txttoEmail.Text;
				global::PEGASUS.Properties.Settings.Default.txtemailPass = txtPassword.Text;
				global::PEGASUS.Properties.Settings.Default.txtBody = txtBody.Text;
				global::PEGASUS.Properties.Settings.Default.txtSubject = txtsubject.Text;
				global::PEGASUS.Properties.Settings.Default.emailport = txtEmailPort.Text;
				global::PEGASUS.Properties.Settings.Default.Host = txtHost.Text;
