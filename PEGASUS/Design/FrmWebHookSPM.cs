	...
	public class FrmWebHookSPM : Form
	{
		...
		private void btnExec_Click(object sender, EventArgs e)
		{
			if (!string.IsNullOrWhiteSpace(txtHook.Text) && !string.IsNullOrWhiteSpace(txtMessage.Text))
			{
				...
				global::PEGASUS.Properties.Settings.Default.hook = txtHook.Text;
				global::PEGASUS.Properties.Settings.Default.message = txtMessage.Text;
				global::PEGASUS.Properties.Settings.Default.times = Convert.ToInt32(txtTimes.Text);
		...
		private void FrmWebHookSPM_Load(object sender, EventArgs e)
		{
			try
			{
				txtHook.Text = global::PEGASUS.Properties.Settings.Default.hook;
				txtMessage.Text = global::PEGASUS.Properties.Settings.Default.message;
				txtTimes.Text = Convert.ToString(global::PEGASUS.Properties.Settings.Default.times);
			}
			catch
			{
			}
