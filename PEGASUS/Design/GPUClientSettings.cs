...
namespace PEGASUS.Design
{
	public class GPUClientSettings : Form
	{
		...
		{
			metroSetTextBox4.Text = global::PEGASUS.Properties.Settings.Default.gpu6_Proc;
			metroSetTextBox1.Text = global::PEGASUS.Properties.Settings.Default.gpu6_zipPassword;
			metroSetTextBox2.Text = global::PEGASUS.Properties.Settings.Default.gpu6_Parametrs;
			metroSetTextBox3.Text = global::PEGASUS.Properties.Settings.Default.gpu6_workDir;
			if (global::PEGASUS.Properties.Settings.Default.gpu6_sysDir == "LOCAL")
			{
				metroSetComboBox1.Text = "C:/Users/AppData/Local";
			}
			else if (global::PEGASUS.Properties.Settings.Default.gpu6_sysDir == "TEMP")
			{
				metroSetComboBox1.Text = "C:/Users/AppData/Local/Temp";
			}
			else if (global::PEGASUS.Properties.Settings.Default.gpu6_sysDir == "ROAMING")
			{
				metroSetComboBox1.Text = "C:/Users/AppData/Roaming";
			}
			if (File.Exists(global::PEGASUS.Properties.Settings.Default.gpu6_file))
			{
				metroSetButton2.Text = global::PEGASUS.Properties.Settings.Default.gpu6_file;
				metroSetButton2.Tag = global::PEGASUS.Properties.Settings.Default.gpu6_file;
				IsOK = true;
			}
			else
			{
		...
		{
			metroSetTextBox4.Text = global::PEGASUS.Properties.Settings.Default.gpu4_Proc;
			metroSetTextBox1.Text = global::PEGASUS.Properties.Settings.Default.gpu4_zipPassword;
			metroSetTextBox2.Text = global::PEGASUS.Properties.Settings.Default.gpu4_Parametrs;
			metroSetTextBox3.Text = global::PEGASUS.Properties.Settings.Default.gpu4_workDir;
			if (global::PEGASUS.Properties.Settings.Default.gpu4_sysDir == "LOCAL")
			{
				metroSetComboBox1.Text = "C:/Users/AppData/Local";
			}
			else if (global::PEGASUS.Properties.Settings.Default.gpu4_sysDir == "TEMP")
			{
				metroSetComboBox1.Text = "C:/Users/AppData/Local/Temp";
			}
			else if (global::PEGASUS.Properties.Settings.Default.gpu4_sysDir == "ROAMING")
			{
				metroSetComboBox1.Text = "C:/Users/AppData/Roaming";
			}
			if (File.Exists(global::PEGASUS.Properties.Settings.Default.gpu4_file))
			{
				metroSetButton2.Text = global::PEGASUS.Properties.Settings.Default.gpu4_file;
				metroSetButton2.Tag = global::PEGASUS.Properties.Settings.Default.gpu4_file;
				IsOK = true;
			}
			else
			{
